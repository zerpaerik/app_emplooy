...
class _ClockinUpdateTimePageState extends ConsumerState<ClockinUpdateTimePage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'More than 1 minute has passed since the last scan. Please update the clock-in time for the workers you are about to scan.',
              style: AppTextStyles.bodyMedium.copyWith(
  ...
  Future<void> _confirmUpdate() async {
    ...
    try {
      await ref.read(clockinProvider.notifier).createNewSession(
